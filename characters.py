...
player_texture = arcade.make_circle_texture(TILE_SIZE-4, arcade.color.PURPLE)
...
enemy_texture = arcade.make_soft_square_texture(TILE_SIZE-4, arcade.color.RED, 255)
